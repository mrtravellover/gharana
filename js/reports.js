...
function renderVillageAnalytics() {
  ...
  const byVillage = {};
  loans.forEach((l) => {
    if (!byVillage[l.village]) byVillage[l.village] = { village: l.village, loans: [], customerIds: new Set() };
    byVillage[l.village].loans.push(l);
    byVillage[l.village].customerIds.add(l.customerId);
  });
