    ...
    try {
      ...
      addCard(`
        ...
        <div class="owl-w-card-body">
          ...
          <div class="owl-w-row"><span class="l">${isFuture ? `Interest as of ${fmtDate(useDate)}` : "Interest due today"}</span><span class="v owl-w-v-gold">${fmtMoney(summary.interestOutstanding)}</span></div>
      ...
      const loanRowsHtml = loanSummaries
        .map(({ loan, summary }, i) => {
          ...
          return `<div class="owl-w-loan-item">
            ...
            <div class="owl-w-row"><span class="l">Principal outstanding</span><span class="v">${fmtMoney(summary.principalOutstanding)}</span></div>
            <div class="owl-w-row"><span class="l">${interestLabel}</span><span class="v owl-w-v-gold">${fmtMoney(summary.interestOutstanding)}</span></div>
          </div>`;
        })
        .join("");
